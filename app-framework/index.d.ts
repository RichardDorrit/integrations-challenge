...
export interface RawCreatePaymentMethodRequest<T, U> extends IProcessorRequest<T> {
  paymentMethod: U;
}

export interface RawCreatePaymentIntentRequest<T, U> extends IProcessorRequest<T> {
  amount: number;
  currencyCode: string;
  paymentMethod: U;
  merchantReference?: string;
